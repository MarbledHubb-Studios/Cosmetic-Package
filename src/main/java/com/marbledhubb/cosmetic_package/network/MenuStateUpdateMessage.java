...
public class MenuStateUpdateMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CosmeticPackage.addNetworkMessage(MenuStateUpdateMessage.class, MenuStateUpdateMessage::buffer, MenuStateUpdateMessage::new, MenuStateUpdateMessage::handler);
	}
}